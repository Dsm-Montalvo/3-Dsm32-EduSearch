...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Mostrar Usuario</h6>
        ...
        <!-- Card Body -->
        <form action="<?=$h->get['base_url'].'/views/usuarios/index.php'?>" >
        <div class="card-body">
        <input type="Hidden" class="form-control" name="Id" value="<?php echo $row['Id_Usuario']; ?>">
            <div class="row mb-2"> 
                <div class="col-6">
                    <label class="form-label" for="">Nombre:</label>
                    <input class="form-control" type="text" name="nombreu" value="<?php echo $row['Nombre'];?>" disabled>
                </div>
                
                <div class="col-6">
                <label class="form-label" for="">Apellido Paterno:</label>
                <input class="form-control" type="text" name="ap_paternou" value="<?php echo $row['Ap_Paterno'];?>" disabled>
            ...
            <div class="row mb-2"> 
                <div class="col-6">
                    ...
                    <input class="form-control" type="text" name="ap_maternou" value="<?php echo $row['Ap_Materno'];?>" disabled>
                </div>
                
                <div class="col-6">
                <label class="form-label" for="">Fecha de Nacimiento:</label>
                <input class="form-control" type="date" name="fechau" value="<?php echo $row['Fecha_Na'];?>" disabled>
                </div>
            </div>
            <div class="row mb-2"> 
                <div class="col-6">
                    <label class="form-label" for="">Email:</label>
                    <input class="form-control" type="email" name="correou" value="<?php echo $row['Email'];?>" disabled>
                </div>
                
                <div class="col-6">
                <label class="form-label" for="">Contraseña:</label>
                <input type="Text" class="form-control" name="contraseñau" value="<?php echo $row['Contraseña'];?>"disabled>
                </div>
            </div>
            <div class="row mb-2"> 
                <div class="col-6">
                    <label class="form-label" for="">Foto de Perfil:</label>
                    <input class="form-control" type="text" name="fotou" value="<?php echo $row['Foto_perfil'];?>" disabled>
                </div>
                ...
                <div class="col-6">
                    ...
                    <select class="form-select" name="cargou" disabled>
